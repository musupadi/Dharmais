package com.ascendant.dharmais.ui.pages.cancer_wound_care;
...
public class cancer_wound_careFragment extends Fragment {

    RecyclerView recyclerView;
    private List<DataModel> mItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mManager;
    public cancer_wound_careFragment() {
    ...
    private void Data(){
        ...
        Call<ResponseModel> KabarBerita = api.Page("Cancer Wound Care");
