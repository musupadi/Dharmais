package com.ascendant.dharmais.ui.pages.prinsipdanmetode;
...
public class prinsipdanmetodeFragment extends Fragment {

    RecyclerView recyclerView;
    private List<DataModel> mItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mManager;
    public prinsipdanmetodeFragment() {
    ...
    private void Data(){
        ...
        Call<ResponseModel> KabarBerita = api.Page("Prinsip dan Metode");
