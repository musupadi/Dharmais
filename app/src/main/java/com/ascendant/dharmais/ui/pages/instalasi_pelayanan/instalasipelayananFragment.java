package com.ascendant.dharmais.ui.pages.instalasi_pelayanan;
...
public class instalasipelayananFragment extends Fragment {

    RecyclerView recyclerView;
    private List<DataModel> mItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mManager;
    public instalasipelayananFragment() {
    ...
    private void Data(){
        ...
        Call<ResponseModel> KabarBerita = api.Page("Instalasi Pelayanan Eksekutif");
