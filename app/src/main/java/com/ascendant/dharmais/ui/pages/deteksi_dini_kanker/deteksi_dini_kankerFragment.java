package com.ascendant.dharmais.ui.pages.deteksi_dini_kanker;
...
public class deteksi_dini_kankerFragment extends Fragment {

    RecyclerView recyclerView;
    private List<DataModel> mItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mManager;
    public deteksi_dini_kankerFragment() {
    ...
    private void Data(){
        ...
        Call<ResponseModel> KabarBerita = api.Page("Deteksi Dini Kanker");
