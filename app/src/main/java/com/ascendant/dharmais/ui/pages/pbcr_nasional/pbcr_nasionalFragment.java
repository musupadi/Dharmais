package com.ascendant.dharmais.ui.pages.pbcr_nasional;
...
public class pbcr_nasionalFragment extends Fragment {

    RecyclerView recyclerView;
    private List<DataModel> mItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mManager;
    public pbcr_nasionalFragment() {
    ...
    private void Data(){
        ...
        Call<ResponseModel> KabarBerita = api.Page("PBCR Nasional");
