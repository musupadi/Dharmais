package com.ascendant.dharmais.ui.pages.microsurgery;
...
public class microsurgeryFragment extends Fragment {

    RecyclerView recyclerView;
    private List<DataModel> mItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mManager;
    public microsurgeryFragment() {
    ...
    private void Data(){
        ...
        Call<ResponseModel> KabarBerita = api.Page("Microsurgery, supermicrosurgery lymphati");
