package com.ascendant.dharmais.ui.pages.hbcr_rsk_dharmais;
...
public class hbcr_rskFragment extends Fragment {

    RecyclerView recyclerView;
    private List<DataModel> mItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mManager;
    public hbcr_rskFragment() {
    ...
    private void Data(){
        ...
        Call<ResponseModel> KabarBerita = api.Page("HBCR RSK Dharmais");
