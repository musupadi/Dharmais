package com.ascendant.dharmais.ui.pages.pelayanan_unggulan;
...
public class pelayanan_unggulanFragment extends Fragment {

    RecyclerView recyclerView;
    private List<DataModel> mItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mManager;
    public pelayanan_unggulanFragment() {
    ...
    private void Data(){
        ...
        Call<ResponseModel> KabarBerita = api.Page("Pelayanan Unggulan");
