package com.ascendant.dharmais.ui.pages.pbcr_dki_jakarta;
...
public class pbcr_rki_jakartaFragment extends Fragment {

    RecyclerView recyclerView;
    private List<DataModel> mItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mManager;
    public pbcr_rki_jakartaFragment() {
    ...
    private void Data(){
        ...
        Call<ResponseModel> KabarBerita = api.Page("PBCR DKI Jakarta");
